...
app.command("collector-status")(collector_status_cmd.collector_status)
app.command("inspect-lead")(inspect_lead_cmd.inspect_lead)
...
app.add_typer(db_cmd.app, name="db", help="Database health and migration-status checks.")
